...
SoftwareSerial eyestarSerial(RX_PIN, TX_PIN, true); // RX, TX
...
int transmitData(){
  byte payload[] = {0x50, 0x50, 0x50, 0x0B, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
